...
//////////////////
  ...
  var chart = new ApexCharts(document.querySelector("#chart-daily2"), options);
  chart.render();
  ...
  var chart = new ApexCharts(document.querySelector("#chart-daily3"), options);
  chart.render();
  ...
  am4core.ready(function () {
    ...
    var chart = am4core.create("chart-cases2", am4charts.PieChart);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
  ...
  am4core.ready(function () {
    ...
    am4core.ready(function () {
      ...
      mapChart.geodata = am4geodata_region_mexico_sonHigh;
      // Set projection
