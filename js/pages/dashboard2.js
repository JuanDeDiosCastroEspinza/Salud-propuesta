...
$(function () {
  ...
  var options = {
    colors: ["#3F51B5", '#0aca91', '#e84a50'],
    series: [{
      name: 'Infectados',
      data: [1254, 2354, 3650, 4752, 5820, 6200, 7400, 8500, 9545, 10700, 11790, 12900, 13003, 14200, 9500, 4003, 4400, 4800, 5800, 6900, 8003, 9900, 11542, 14003, 17003, 21054, 28003, 36003, 45003, 55003]
    }, {
      name: 'Recuperados',
      data: [240, 286, 302, 365, 522, 565, 598, 642, 762, 791, 821, 842, 866, 986, 1011, 1224, 1384, 1601, 1731, 1968, 2099, 2826, 3145, 3454, 4645, 5117, 6545, 9541, 11451, 15454]
    }, {
      name: 'Muertes',
  ...
  var chart = new ApexCharts(document.querySelector("#world-cases"), options);
  chart.render();
  ...
  var chart = new ApexCharts(document.querySelector("#world-daily-cases"), options);
  chart.render();
...
var options = {
  ...
  series: [{
    name: 'Infectados',
    data: [1254, 1354, 1650, 1752, 1820, 2200, 12400, 2500, 2545, 2700, 2790, 24900, 3003, 3200, 3500, 4003, 4400, 4800, 5800, 6900, 8003, 40000, 11542, 14003, 17003, 21054, 28003, 36003, 45003, 45000]
  }, {
    name: 'Recuperados',
    data: [240, 286, 302, 365, 522, 565, 598, 642, 762, 791, 821, 842, 866, 986, 1011, 1224, 1384, 1601, 1731, 1968, 2099, 2826, 3145, 3454, 4645, 5117, 6545, 9541, 11451, 15454]
  }, {
...
var chart = new ApexCharts(document.querySelector("#world-cases-2"), options);
chart.render();
...
///////////////////////////////////////////////////////////////////////////////////////////////7
  var options = {
    series: [{
      name: 'Confirmed',
      data: [770, 198, 178, 145, 112, 86, 82]
    }, {
      name: 'Recovered',
      data: [70, 77, 47, 83, 36, 11, 77]
    }, {
      name: 'Deaths',
      data: [41, 21, 23, 4, 19, 2, 4]
    }],
    chart: {
      type: 'bar',
      height: 350,
    ...
    xaxis: {
      categories: ['USA', 'Spain', 'Italy', 'Germany', 'France', 'Turkey', 'China'],
      labels: {
  ...
  var chart = new ApexCharts(document.querySelector("#affected_country"), options);
  chart.render();
  ...
  am4core.ready(function () {
    ...
    am4core.ready(function () {
      ...
      title.text = "COVID-19 Datos de contagio";
      title.align = "left";
      ...
      filterLabel.tooltipText = "Este filtro permite eliminar países con muchos casos del mapa para que sea posible comparar países con un número menor de casos."
      filterLabel.fill = am4core.color("#ffffff");
      ...
      label.text = "Las estadísticas del día actual pueden estar incompletas hasta que los países envíen sus datos.";
